...
function dbDump(config, output_paths, noExec) {
    ...
    if (typeof config.ssh_host === "undefined") { // we're not using SSH
        ...
        // TODO: separate connection and mysqldump commands and execute via SSH2
    ...
    if (!noExec) {
        ...
        // Capture output...
        //
        // TODO: error/exit on SSH connection fail
        // TODO: error/exit on MYSQLDUMP execution fail
        var output = shell.exec(cmd, {silent: true}).output;

        // Write output to file using native Grunt methods
        grunt.file.write( output_paths.file, output ); // TODO: add check to ensure file write was successful
    }

    if ( grunt.file.exists(output_paths.file) ) { // TODO: remove need for this check
